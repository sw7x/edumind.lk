                        ...
                        <table cellpadding="0" cellspacing="0" style="border:none" width="100%">
                            ...
                            <tr>
                                <td align="left" style="padding:17px 20px" valign="top">
                                    ...
                                    <div style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#7789a2">Reset Password</div>

                                    <div style="font-size:11px;padding:18px 0 20px 0">
                                        <p style="font-size: 14px;">This link valid 4 hours</p>
                                        <p style="font-size: 14px;">Please click the following link to reset your password in Edumind.lk</p>
