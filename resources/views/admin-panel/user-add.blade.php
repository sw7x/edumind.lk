        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li><a class="nav-link active" data-toggle="tab" href="#tab-add-teachers">Add teachers</a></li>
                    <li><a class="nav-link" data-toggle="tab" href="#tab-add-students">Add students</a></li>
                    <li><a class="nav-link" data-toggle="tab" href="#tab-add-marketers">Add marketers</a></li>
                    <li><a class="nav-link" data-toggle="tab" href="#tab-add-editor">Add Editor</a></li>
                </ul>

                <div class="tab-content mb-3">

                    <div role="tabpanel" id="tab-add-teachers" class="tab-pane active">
                    ...
                    <div role="tabpanel" id="tab-add-students" class="tab-pane">
                        <div class="panel-body">
                    ...
                    <div role="tabpanel" id="tab-add-marketers" class="tab-pane">
                        <div class="panel-body">

                            <h3>Add new Marketer</h3>
                            @foreach ($errors->all() as $error)
                                {{-- $error --}}
                            @endforeach
                    ...
                    <div role="tabpanel" id="tab-add-editor" class="tab-pane">
                        <div class="panel-body">
