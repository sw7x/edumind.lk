@extends('admin-panel.layouts.master',['title' => 'Coupon code usage'])
					    			...
					    			<div class="col-md-10">
					    				<div class="card-body p-0 row">					    					
						                    <div class="col-md-6 mt-1 px-3">
						                    	...
						                    	<div class="text-justify mt-1 text-lg font-bold text-black">Coupon code : ABC4445</div>
									...
									<div class="col-md-10">
										<div class="card-body p-0 row">
											<div class="col-md-6 mt-1 px-3">
												...
												<div class="mt-1 mb-1 spec-1 text-sm">Teacher : A.B.C Saman Hettiarachchi</div>
												<div class="mt-1 mb-1 spec-1 text-sm">Student : F.C Nimal Hettiarachchi</div>
												<div class="text-justify mt-3 text-xl font-bold text-black">Coupon code : ABC4445</div>
											</div>
											<div class="col-md-6 align-items-center align-content-center border-left mt-1">
												<div class="d-flex flex-column mt-4">
