        ...
        <div class="col-lg-12">
            ...
            <div class="tabs-container">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li><a class="nav-link {{ ($userType == 'teacher') ? 'active' : 'disabled' }}" data-toggle="tab" href="#tab-add-teachers">Edit teacher</a></li>
                    <li><a class="nav-link {{ ($userType == 'student') ? 'active' : 'disabled' }}" data-toggle="tab" href="#tab-add-students">Edit student</a></li>
                    <li><a class="nav-link {{ ($userType == 'marketer') ? 'active' : 'disabled' }}" data-toggle="tab" href="#tab-add-marketers">Edit marketer</a></li>
                    <li><a class="nav-link {{ ($userType == 'editor') ? 'active' : 'disabled' }}" data-toggle="tab" href="#tab-add-editor">Edit editor</a></li>
                </ul>

                <div class="tab-content mb-3">

                    @if($userType == 'teacher')
                    <div role="tabpanel" id="tab-add-teachers" class="tab-pane {{ ($userType == 'teacher') ? 'active' : '' }}">
                    ...
                    @if($userType == 'student')
                    <div role="tabpanel" id="tab-add-students" class="tab-pane {{ ($userType == 'student') ? 'active' : '' }}">
                        <div class="panel-body">
                    ...
                    <div role="tabpanel" id="tab-add-marketers" class="tab-pane {{ ($userType == 'marketer') ? 'active' : '' }}">
                        <div class="panel-body">
                    ...
                    @if($userType == 'editor')
                    <div role="tabpanel" id="tab-add-editor" class="tab-pane {{ ($userType == 'editor') ? 'active' : '' }}">
                    <div class="panel-body">
...
<script>
	...
	jQuery(document).ready(function ($) {
		...
		selectedTab = (selectedTab=='')?'#tab-add-teachers':selectedTab;
