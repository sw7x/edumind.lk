...
@section('content')
    <div class="row" id="">
        <div class="col-lg-12">
            ...
            @if(isset($otherUserComments) && isNotEmptyArray($otherUserComments)) 
                <div class="ibox ">                
                            ...
                            @foreach($otherUserComments as $comment)
                                ...
                                <div class="vertical-timeline-block other-user-block">
                                    ...
                                    <div class="vertical-timeline-content rounded-lg">
                                        ...
                                        <form class="comment-destroy" action="{{ route('admin.feedbacks.delete-comment', 777) }}" method="POST">
                                            @method('DELETE')
            ...
            @else                
                <x-flash-message 
                    ...
                    message="Other user's messages are not available or not in correct format"  
                    message2=""  
                    :canClose="false" />                
            @endif
