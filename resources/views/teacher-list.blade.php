    ...
    <div class="main-container container">
        <div class="lg:flex lg:space-x-10 mt-8 mb-4">
            ...
            <div class="w-full">
                    ...
                    <div class="_space-y-7 mt-6 flex flex-row justify-between flex-wrap">
                        ...
                        @foreach($teachers as $teacher)
                            <div class="relative p-3 bg-white shadow rounded-md flex items-center space-x-3 mb-10 teacher-card">
                                ...
                                <div class="flex-1">
                                    <div class="font-semibold"><a href="">{{$teacher->full_name}}</a></div>

                                    <hr class="my-2">
                                    {{--<div class="text-sm"><strong>Subjects</strong>: Science, Maths, Ai</div>--}}
                                    <div class="text-sm">
                                        <strong>No of courses</strong>: {{$teacher->getCourseCount()}} Course{{ $teacher->getCourseCount() == 1 ? "" : "s" }}
                                    </div>
                                    <hr class="my-2">
                ...
                @else
                    <h2 class="text-base font-semibold">No teachers available to show</h2>
                @endif
