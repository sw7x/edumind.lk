        ...
        <div class="max-w-5xl md:p-5 mx-auto">
            <div class="---lg:flex lg:space-x-10 bg-white rounded-md shadow max-w-3x  mx-auto md:p-8 p-3">
                <div class="">
                    ...
                    <div>
                        <h2 class="font-semibold mb-3 text-xl lg:text-3xl">Error</h2>
                        <hr class="mb-5">
                        ...
                        <div class="content centered">
                         	<img class="align-center m-auto mb-10" style="width:250px;" src="{{asset('images/errors/error.png')}}">
                            
                            @if(isset($errMsg) && $errMsg)
                                <h1 class="font-semibold mb-2 text-xl text-center">{{$errMsg}}</h1>                                
                            @else
                                <h1 class="font-semibold mb-2 text-xl text-center">There was a problem processing your request.</h1>
                            @endif
